U ovom primeru koristi se Django modul za implementaciju web aplikacije
koja sadrzi primere za D3 JavaScript biblioteku za vizuelizaciju podataka.
...
Prilikom pokretanja potrebno je prvo instalirati plugine D3Core i UcitavanjeKod,
a zatim se moze pokrenuti Django aplikacija komandom
...
File -> Settings
pronaci prikaz
Project:D3DjangoPlugin->Project Interpreter
...
Takodje je potrebno napraviti i konfiguracije za pokretanje setup.py skripti
tako sto se ode na:
Run -> Edit configurations
Napravi se nova Python konfiguracija i za polje
Script:
se izabere setup.py modul
Script parameters:
se upise:
develop
